...
func (c *fPTCustomerClient) ChangePassword(ctx context.Context, in *ChangePasswordRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
func (c *fPTCustomerClient) BookingHistory(ctx context.Context, in *BookingHistoryRequest, opts ...grpc.CallOption) (*BookingHistoryResponse, error) {
...
func (UnimplementedFPTCustomerServer) ChangePassword(context.Context, *ChangePasswordRequest) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ChangePassword not implemented")
}
func (UnimplementedFPTCustomerServer) BookingHistory(context.Context, *BookingHistoryRequest) (*BookingHistoryResponse, error) {
