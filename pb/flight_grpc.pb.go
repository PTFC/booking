...
type FPTFlightClient interface {
	...
	SearchFlight(ctx context.Context, in *SearchFlightRequest, opts ...grpc.CallOption) (*ListFlightResponse, error)
}
...
func (c *fPTFlightClient) SearchFlight(ctx context.Context, in *SearchFlightRequest, opts ...grpc.CallOption) (*ListFlightResponse, error) {
...
type FPTFlightServer interface {
	...
	SearchFlight(context.Context, *SearchFlightRequest) (*ListFlightResponse, error)
...
func (UnimplementedFPTFlightServer) SearchFlight(context.Context, *SearchFlightRequest) (*ListFlightResponse, error) {
